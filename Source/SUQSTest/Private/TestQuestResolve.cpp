...
bool FTestQuestTimedResolve::RunTest(const FString& Parameters)
{
	...
	TestTrue("Task resolve should be blocked", Progression->GetTaskState("Q_TimedResolve", "T_Single")->IsResolveBlocked());
	...
	TestTrue("Quest resolve should be blocked", Progression->GetQuest("Q_TimedResolve")->IsResolveBlocked());
...
bool FTestQuestGatedResolve::RunTest(const FString& Parameters)
{
	...
	TestTrue("Task resolve should be blocked", Progression->GetTaskState("Q_GatedResolve", "T_Single")->IsResolveBlocked());
...
bool FTestQuestManualResolve::RunTest(const FString& Parameters)
{
	...
	TestTrue("Task resolve should be blocked", Progression->GetTaskState("Q_ManualResolve", "T_Single")->IsResolveBlocked());
	...
	TestTrue("Quest resolve should be blocked", Progression->GetQuest("Q_ManualResolve")->IsResolveBlocked());
